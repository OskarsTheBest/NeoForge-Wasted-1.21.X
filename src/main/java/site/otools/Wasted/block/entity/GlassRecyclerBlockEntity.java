...
public class GlassRecyclerBlockEntity extends RecyclerBlockEntity {
    ...
    private static final ResourceKey<LootTable> GLASS_RECYCLER_LOOT =
    ...
    protected void craftItem() {
        ...
        LootTable table = serverLevel.getServer().reloadableRegistries().getLootTable(GLASS_RECYCLER_LOOT);
